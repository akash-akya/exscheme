...
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 35, C =< 38 ->
    yystate(6, Ics, Line, Tlen+1, 1, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 42 ->
    yystate(6, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 33 ->
    yystate(1, Ics, Line, Tlen+1, 2, Tlen);
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 35 ->
    yystate(1, Ics, Line, Tlen+1, 2, Tlen);
...
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 8 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 31 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 35, C =< 38 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 42, C =< 47 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 58 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
...
yystate(2, [10|Ics], Line, Tlen, _, _) ->
    yystate(2, Ics, Line+1, Tlen+1, 5, Tlen);
...
-file("src/scheme_lexer.xrl", 8).
yyaction_0(TokenChars, TokenLine) ->
     { token, { int, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("src/scheme_lexer.xrl", 9).
yyaction_1(TokenChars, TokenLine) ->
...
-file("src/scheme_lexer.xrl", 12).
yyaction_4(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_5/0}).
-file("src/scheme_lexer.xrl", 13).
yyaction_5() ->
     skip_token .
